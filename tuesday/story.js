const story = {
  ...
  pages: {
    ...
    'spread_18': {
      ...
      overlays: [
        { src: '_images/Spread_18-z1.png', jitter: 'z-seq-1', trigger: 'bubble-start', index: 1 },
        { src: '_images/Spread_18-z2.png', jitter: 'z-seq-2', trigger: 'bubble-start', index: 1 },
    ...
    'spread_19': {
      ...
      overlays: [
        { src: '_images/Spread_19-20-23-beep.png', jitter: 'beep', trigger: 'bubble-start', index: 0, delay: 500 },
        { src: '_images/Spread_19-20-23-z1.png', jitter: 'z-seq-1', trigger: 'bubble-start', index: 2 },
        { src: '_images/Spread_19-20-23-z2.png', jitter: 'z-seq-2', trigger: 'bubble-start', index: 2 },
